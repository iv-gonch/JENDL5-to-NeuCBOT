...
# Файл содержит номера строк ENDF
...
class ENDF:
    ...
    JPindex = LIPindex = LANGindex = 2  # номер значения JP (?), LIP (?), LANG (что-то про )
            # Вот что написано про LANG при LAW=2
            ...
            # Вот что написано про LANG в общем описании
