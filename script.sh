...
# python3 ./main.py -graph Al27 &

# python3 ./main.py -graph B10 &

# python3 ./main.py -graph B11 &

# python3 ./main.py -graph Be9 &

# python3 ./main.py -graph C12 &

# python3 ./main.py -graph C13 &

# python3 ./main.py -graph F19 &

# python3 ./main.py -graph Li6 &

# python3 ./main.py -graph Li7 &

# python3 ./main.py -graph N14 &

# python3 ./main.py -graph N15 &

# python3 ./main.py -graph Na23 &

# python3 ./main.py -graph O16 &

# python3 ./main.py -graph O17 &

# python3 ./main.py -graph O18 &

# python3 ./main.py -graph Si28 &

# python3 ./main.py -graph Si29 &

# python3 ./main.py -graph Si30 &
